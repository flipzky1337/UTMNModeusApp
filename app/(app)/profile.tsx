    ...
    return (
      <View className={'flex px-2'}>
        <View className={'my-2 py-1 px-2 rounded-t-md rounded-b-md flex bg-white gap-1'}>
          ...
          <Text className={'font-bold'}>Специальность: </Text><Text numberOfLines={3} style={{flexWrap: 'wrap'}}>{primaryData.specialtyCode} {primaryData.specialtyName}: {primaryData.profile.name}</Text>
